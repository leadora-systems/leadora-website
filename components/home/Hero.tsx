  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 80% 60% at 50% -10%, rgba(30,111,255,.18) 0%, transparent 70%),
            radial-gradient(ellipse 40% 40% at 90% 60%, rgba(0,200,255,.08) 0%, transparent 60%),
            radial-gradient(ellipse 30% 30% at 10% 80%, rgba(255,107,43,.06) 0%, transparent 60%)
          `,
        }}
      />
      <div
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(30,111,255,.18), transparent 70%)",
      ...
      <div className="container relative z-[2] w-full">
        <div className="text-center">
          <div className="fade-up mb-8 inline-flex items-center gap-2 rounded-full border border-blue/25 bg-blue/10 px-4 py-1.5 text-xs uppercase tracking-widest text-cyan">
          ...
          <p className="fade-up-3 mx-auto mb-10 max-w-[600px] text-[clamp(15px,1.8vw,18px)] leading-relaxed text-muted">
          ...
          <div className="fade-up-4 mt-[72px] flex flex-wrap justify-center gap-10 border-t border-glass-border pt-12">
            {heroStats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="font-syne text-[32px] font-extrabold grad-text">
                  {stat.value}
                </div>
