...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms & Conditions">
      ...
      <h3 className="font-syne text-lg font-bold text-text">Use of website</h3>
      <p>
      ...
      <h3 className="font-syne text-lg font-bold text-text">Intellectual property</h3>
      <p>
      ...
      <h3 className="font-syne text-lg font-bold text-text">Limitation of liability</h3>
      <p>
        We are not liable for indirect or consequential damages arising from use
        of this website or reliance on its content.
      </p>
      <h3 className="font-syne text-lg font-bold text-text">Governing law</h3>
