...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <h3 className="font-syne text-lg font-bold text-navy">Information we collect</h3>
      <p>
      ...
      <h3 className="font-syne text-lg font-bold text-navy">How we use information</h3>
      <p>
      ...
      <h3 className="font-syne text-lg font-bold text-navy">Data retention</h3>
      <p>
        We retain contact and application data only as long as necessary for
        business purposes or as required by law.
      </p>
      <h3 className="font-syne text-lg font-bold text-navy">Contact</h3>
      <p>
