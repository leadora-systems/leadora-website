...
export default function CookiesPage() {
  return (
    <LegalLayout title="Cookie Policy">
      ...
      <h3 className="font-syne text-lg font-bold text-navy">What are cookies?</h3>
      <p>
      ...
      <h3 className="font-syne text-lg font-bold text-navy">Cookies we may use</h3>
      <ul className="list-inside list-disc space-y-2">
        <li>Essential cookies for site functionality</li>
        <li>Analytics cookies (e.g. GA4) to measure traffic and performance</li>
      </ul>
      <h3 className="font-syne text-lg font-bold text-navy">Managing cookies</h3>
      <p>
